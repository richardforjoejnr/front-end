...
test.describe('Chat Page', () => {
  test('Page loads with the send form and messages list @Smoke', async ({ chatPage }) => {
    // Arrange / Act
  ...
  test('Existing messages are rendered on load @Smoke', async ({ chatPage, messagesDataManager }) => {
    // Arrange
  ...
  test('Each message has a delete button @regression', async ({ chatPage, messagesDataManager }) => {
    // Arrange
    const message = await messagesDataManager.create();
  ...
  test('Messages are listed oldest first @regression', async ({ chatPage, messagesDataManager }) => {
    // Arrange
